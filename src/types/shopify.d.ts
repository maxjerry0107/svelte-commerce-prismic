   ...
   * `{
     *   "product": {
      ...
      export interface NodeTypeResolver<TParent = any> {
        (parent: TParent, context: any, info: GraphQLResolveInfo): 'Article' | 'Metafield' | 'Blog' | 'Collection' | 'Product' | 'ProductOption' | 'ProductVariant' | 'Location' | 'MailingAddress' | 'Checkout' | 'AppliedGiftCard' | 'CheckoutLineItem' | 'Order' | 'Page' | 'Shop' | 'MediaImage' | 'ShopPolicy' | 'GenericFile' | 'Metaobject' | 'Video' | 'Comment' | 'Cart' | 'CartLine' | 'Menu' | 'MenuItem' | 'UrlRedirect' | 'Payment' | 'ExternalVideo' | 'Model3d';
      }
